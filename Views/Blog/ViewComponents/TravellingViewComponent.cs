...
{
    public class TravellingViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext dbContext;
        private readonly IMapper mapper;

        public TravellingViewComponent(ApplicationDbContext dbContext, IMapper mapper)
        {
        ...
        {
            var recipes = await this.dbContext.BlogPosts.Where(c => c.Category.Equals("Travelling"))
                .ToArrayAsync();
